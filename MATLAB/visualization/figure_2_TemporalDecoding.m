...
switch param.region
    ...
    case 'whole'
        param.data_file_name_st = 'whole_brain_decoding_stim_resp_aligned_coh_levels_st';
        param.data_file_name_rp = 'whole_brain_decoding_stim_resp_aligned_coh_levels_rp';
end
...
pdf_file_name          = ['decoding_' num2str(param.cond) '_' date];
...
for iCoh = 1 : 4
    ...
    this_data_stim = squeeze(decoding_data.st(iCoh, :, param.cond, :));
    this_pval_stim = squeeze(decoding_data.st_pval(iCoh, param.cond, :));
    
    this_data_dec  = squeeze(decoding_data.rp(iCoh, :, param.cond, :));
    this_pval_dec  = squeeze(decoding_data.rp_pval(iCoh, param.cond, :));

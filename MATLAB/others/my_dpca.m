...
N = 64;%100;   % number of neurons
T = 400;%20;     % number of time points
S = 4;%7;       % number of stimuli
D = 2;          % number of decisions
E = 60;%20;     % maximal number of trial repetitions
...
margNames = {'Fam/NanFam', 'Noise', 'Condition-independent', 'Interaction'};

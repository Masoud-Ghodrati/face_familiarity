function phase_Scram_img = calculated_PhaseScrambleImage(image_File, w, numSample)
...
phase_Scram_img = cell(1, numSample);
for iNoise_Sample = 1 : numSample
    ...
    % inverse FFT
    scrambled_FFT = img_FFTmag.*exp(1i*final_phi);
    scrambled_img = abs(ifft2(scrambled_FFT));
    
    phase_Scram_img{iNoise_Sample} = scrambled_img;
end
